Shader "MK/Toon/Free"
{
	...
	{
		//Main
		_Color ("Color", Color) = (0.86,0.86,0.86,1)
		...
		//Light
		_LightThreshold("LightThreshold", Range (0.01, 1)) = 0.5
		...
		_HighlightColor ("Highlight Color", Color) = (1.0, 0.88, 0.62, 1.0)
		_ShadowIntensity("Shadow Intensity", Range (0.0, 2.0)) = 0.75
		...
		_RimIntensity("Intensity", Range (0, 1)) = 0.0
		...
		//Emission
		_EmissionColor("Emission Color", Color) = (0.86,0.86,0.86)
